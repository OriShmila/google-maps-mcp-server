...
This module implements the core MCP server for Google Maps API integration.
"""
...
from google_maps_mcp_server.handlers import (
    TOOL_FUNCTIONS,
)  # Updated to google_maps_mcp_server

logging.basicConfig(level=logging.INFO, format="%(asctime)s %(levelname)s %(message)s")
logging.getLogger("httpx").setLevel(logging.WARNING)

logger = logging.getLogger("GoogleMapsMCP")  # Updated to GoogleMapsMCP
